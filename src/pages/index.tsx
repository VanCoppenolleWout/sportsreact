...
import { getFootballStandings, getFootballStandings2 } from '@/utils/dataAccess'
  ...
  return (
    <>
      {standings.map((s: Standings) => (
        <div key={s.standings.rank}>
          <p>
            {s.standings.rank} {s.standings.points} {s.standings.team.name}
          </p>
          <Image
